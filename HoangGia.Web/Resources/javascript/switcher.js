...
$(document).ready(function() {
	var e =  '<div class="switcher-container">'+
               ...
               '<div class="selector-box">'+
                    ...
                    '<div class="sw-pattern pattern"><h3>Background pattern:</h3>'+
                        '<a href="#" class="sw-pattern" data-image="/Resources/images/pattern/1.png"><img src="/Resources/images/pattern/1.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="/Resources/images/pattern/2.png"><img src="/Resources/images/pattern/2.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="/Resources/images/pattern/3.png"><img src="/Resources/images/pattern/3.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="/Resources/images/pattern/4.png"><img src="/Resources/images/pattern/4.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="/Resources/images/pattern/5.png"><img src="/Resources/images/pattern/5.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="/Resources/images/pattern/6.png"><img src="/Resources/images/pattern/6.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="/Resources/images/pattern/7.png"><img src="/Resources/images/pattern/7.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="/Resources/images/pattern/8.png"><img src="/Resources/images/pattern/8.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="/Resources/images/pattern/9.png"><img src="/Resources/images/pattern/9.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="/Resources/images/pattern/10.png"><img src="/Resources/images/pattern/10.png" alt="image"></a>' +
                    '</div>'+               
                  '<div class="clearfix"></div>'+
               '</div>'+
            '</div>';
    ...
    setColor: function(e) {
        ...
        $(t.headLink).attr("href", "/Resources/stylesheets/colors/" + e + ".css");
    ...
    var switchAnimate = {
		loadEvent: function() {
		    $(".switcher-container h2 a.sw-click").on('click',
		        function(e) {
