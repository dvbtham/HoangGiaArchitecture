...
; (function ($) {
    ...
    var validate = function () {
        ...
        if ($('#Name').val().trim() === "") {
            ...
            $('#Name').attr("placeholder", "Nhập họ và tên!");
            isValid = false;
        }
        if ($('#Title').val().trim() === "") {
            $('#Title').css('border-color', 'Red');
            $('#Title').attr("placeholder", "Nhập tiêu đề!");
            isValid = false;
        }
        if ($('#Email').val().trim() === "") {
            $('#Email').css('border-color', 'Red');
            $('#Email').attr("placeholder", "Nhập email!");
            isValid = false;
        }
        if ($('#Message').val().trim() === "") {
            $('#Message').css('border-color', 'Red');
            $('#Message').attr("placeholder", "Nhập nội dung!");
            isValid = false;
        }
        return isValid;
    }
    var contactAjaxForm = function () {
        $("#submit").on('click',
            function () {
                ...
                $.ajax({
                    ...
                    success: function () {
                        alert('Gửi thông tin thành công, chúng tôi sẽ phản hồi lại sớm nhất!');
                        $('.loading').addClass('hide');
                    },
                    error: function (error) {
                        $('.loading').addClass('hide');
                        console.log(error.responseText);
                        alert('Lỗi gửi thông tin, vui lòng gửi lại hoặc liên hệ admin!');
                    }
                });
